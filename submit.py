...
def get_args_parser(
    ...
    parser.add_argument(
        ...
        "--gpus",
        "--gpus-per-node",
        default=2, # change 8 to 2 becuase ucf cluster does not have 8 gpus per node,
        type=int,
    ...
    parser.add_argument(
        "--partition",
        default='normal', # chane this to normal from slurm_partition,
        type=str,
...
def submit_jobs(task_class, args, name: str):
    ...
    kwargs = {}
    if args.use_volta32:
        kwargs["slurm_constraint"] = "gpu32" # "volta32gb"
    if args.comment:
